...
class TestTranscriptionService:
    ...
    def test_init(self, mock_whisper_model):
        ...
        with patch("app.services.transcription.WhisperModel", return_value=mock_whisper_model):
    ...
    def test_transcribe_empty_result(self):
        ...
        with patch("app.services.transcription.WhisperModel", return_value=mock_model):
            from app.services.transcription import TranscriptionService
            service = TranscriptionService()
